import { Component, TemplateRef, ViewChild, OnInit, Input, Output, EventEmitter, ElementRef, forwardRef, OnDestroy } from '@angular/core';
import { FormGroupDirective, ControlValueAccessor, NG_VALUE_ACCESSOR } from '@angular/forms';
...
export class UEditorComponent implements ControlValueAccessor {
	...
	ngOnInit() {
		...
		this.ue = (<any>window).UE.getEditor(this.editor.nativeElement, {
