import { Component, ViewContainerRef, ViewChild, Directive, Input, OnDestroy, ComponentFactoryResolver, ResolvedReflectiveFactory, forwardRef, ComponentRef, ChangeDetectorRef, Injector, ReflectiveInjector } from '@angular/core';
